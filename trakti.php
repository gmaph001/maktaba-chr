...
<head>
     ...
     <title>Charambe | Maktaba | trakti</title>
</head>
<body>
     <div class="main">
               ...
               <div class="date">
                    ...
                    <div class="years-collection">
                         <?php
                              for($i=$size2; $i>0; $i--){
                                   if($year[$i] === $yearpage){
                                        echo "<a href='trakti.php?mwaka=$year[$i]&&mwezi=$monthpage' class='year active'>$year[$i]</a>";
                                   }
                                   else{
                                        echo "<a href='trakti.php?mwaka=$year[$i]&&mwezi=$monthpage' class='year'>$year[$i]</a>";
                                   }
                              }
                         ?>
                    </div>
                         ...
                         <?php
                              for($i=$size3; $i>0; $i--){
                                   if($month[$i] === $monthpage){
                                        echo "<a href='trakti.php?mwaka=$yearpage&&mwezi=$month[$i]' class='year active'>$month[$i]</a>";
                                   }
                                   else{
                                        echo "<a href='trakti.php?mwaka=$yearpage&&mwezi=$month[$i]' class='year'>$month[$i]</a>";
                                   }
                              }
                         ?>
                    </div>
               ...
               <div class="ordered">
                    <h1>Yaliyoagizwa:</h1>
                         <?php
                              for($i=$size4-1; $i>=0; $i--){
                                   echo "
                                             <form action='submit-machapisho.php?cat=trakti&&kundi=yaliyoagizwa&&year=$yearpage&&month=$monthpage' method='POST' name='submit' enctype='multipart/form-data'>
               ...
               <div class="ordered">
                    <h1>Yaliyopo:</h1>
                         <?php
                              for($i=$size5-1; $i>=0; $i--){
                                   echo "
                                             <form action='submit-machapisho.php?cat=trakti&&kundi=yaliyopo&&year=$yearpage&&month=$monthpage' method='POST' name='submit' enctype='multipart/form-data'>
                                                  <div class='ordered-details'>
